...
void randomizeParticles()
{
    ...
    for(i=0;i<N;i++)
    {
        ...
        //PARTE 2
        velocity[i][2] = 0.001 * 0.5 * ((rand()%256)/256.0+2.0);
        //FINE PARTE 2
    }
...
static void init()
{
    ...
    //glewInit();
    program = initShader("/Users/erika/Desktop/MAGISTRALE/1anno2ciclo/Fondamenti di Computer Graphics/Laboratorio/lab6pt2/lab6pt2/v.glsl", "/Users/erika/Desktop/MAGISTRALE/1anno2ciclo/Fondamenti di Computer Graphics/Laboratorio/lab6pt2/lab6pt2/f.glsl");
